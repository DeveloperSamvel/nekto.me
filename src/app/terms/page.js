    ...
    <>
      ...
      <main className="grow">
        <section className="py-8 bg-white lg:py-24 dark:bg-gray-900">
          <div className="max-w-4xl px-4 mx-auto lg:px-4 format dark:format-invert">
            ...
            <p>
              ...
              and Bergside Inc. ("Company", "we", "us", or "our"), concerning
            ...
            <p>
              ...
              these Terms of Use; (2) you are not a minor in the jurisdiction in
              which you reside; (3) you will not access the Site or the
              Marketplace Offerings through automated or non-human means,
              ...
              of the Site or the Marketplace Offerings will not violate any
            ...
            <p>
              ...
              Site’s ontent. We do not endorse or recommend any Marketplace
            ...
            <p>
              ...
              TO THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR Bergside
              Inc. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW
